...
const GITHUB_ALL_RELEASES_URL =
  "https://github.com/multica-ai/multica/releases";

export function DownloadClient({
  release,
  allReleasesUrl = GITHUB_ALL_RELEASES_URL,
}: {
  release: LatestRelease;
  /** "All releases" / fallback link target. Defaults to the public
   *  GitHub releases page; internal feed mode passes the feed dir so
   *  no link points at the unreachable external GitHub. */
  ...
  const releaseHtmlUrl = release.htmlUrl ?? allReleasesUrl;
